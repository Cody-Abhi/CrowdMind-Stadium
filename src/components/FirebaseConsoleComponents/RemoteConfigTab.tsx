    ...
    >
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-void-400 text-sm max-w-2xl leading-relaxed">
            Real-time variable injection for the Plant Lusail mesh. Changes propagate to all edge nodes instantly via Firestore event listeners.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel p-6 space-y-4 group">
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <span className="text-[10px] font-mono font-bold text-neon-cyan-400 uppercase tracking-tighter">PLANT_THROUGHPUT_SCALE</span>
                <h4 className="text-white font-semibold text-sm">Operational Yield Incentive Scaling</h4>
              </div>
            ...
            <p className="text-[11px] text-void-500 leading-relaxed italic">
              Dynamically adjusts target performance yield rate across all plant digital registers.
            </p>
        </div>
        ...
        <div className="glass-panel p-6 space-y-4 group">
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <span className="text-[10px] font-mono font-bold text-neon-purple-400 uppercase tracking-tighter">COOLING_CORE_THRESHOLD</span>
                <h4 className="text-white font-semibold text-sm">Core Thermal Climate Optimization</h4>
              </div>
            ...
            />
            <p className="text-[11px] text-void-500 leading-relaxed italic">
              Sets the target temperature for the mechanical cooling cells.
            </p>
        </div>
        ...
        <div className="glass-panel p-6 space-y-4 group">
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <span className="text-[10px] font-mono font-bold text-neon-blue-400 uppercase tracking-tighter">RAG_QUERY_DELAY_LIMIT</span>
                <h4 className="text-white font-semibold text-sm">Vector Database Ingress Delay Limit</h4>
              </div>
            ...
            />
            <p className="text-[11px] text-void-500 leading-relaxed italic">
              Balances database verification depth against query speed.
            </p>
        </div>
        ...
        <div className="glass-panel p-6 flex flex-col justify-between">
            <div className="flex justify-between items-start mb-6">
              <div className="space-y-1">
                <span className="text-[10px] font-mono font-bold text-state-danger-text uppercase tracking-tighter">EMERGENCY_SHUTDOWN_ENABLED</span>
                <h4 className="text-white font-semibold text-sm">Plant Emergency Shutdown Override</h4>
              </div>
            ...
            >
              {remoteConfig.emergencyLockdown ? 'ABORT SHUTDOWN' : 'INITIATE EMERGENCY SHUTDOWN'}
            </button>
        </div>
      </div>
    </motion.div>
